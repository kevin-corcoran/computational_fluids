...
silent only
silent tabonly
cd ~/ucsc/master-2/quarter-1/computational-fluids/assignment_03/code
...
silent! normal! zE
let s:l = 67 - ((35 * winheight(0) + 22) / 45)
...
normal! 017|
tabnext
edit ~/ucsc/master-2/quarter-1/computational-fluids/cfd/cfd/cfd.py
set splitbelow splitright
wincmd t
set winminheight=0
set winheight=1
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 51 - ((14 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
51
normal! 034|
tabnext
edit ~/ucsc/master-2/quarter-1/computational-fluids/assignment_02/sample_code/advect.m
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 134 + 91) / 183)
exe 'vert 2resize ' . ((&columns * 48 + 91) / 183)
argglobal
setlocal keymap=
setlocal noarabic
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 78 - ((41 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
78
...
wincmd w
argglobal
if bufexists("~/ucsc/master-2/quarter-1/computational-fluids/assignment_02/sample_code/upwind.m") | buffer ~/ucsc/master-2/quarter-1/computational-fluids/assignment_02/sample_code/upwind.m | else | edit ~/ucsc/master-2/quarter-1/computational-fluids/assignment_02/sample_code/upwind.m | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
set stal=1
badd +0 driver.py
badd +1 ~/ucsc/master-2/quarter-1/computational-fluids/cfd/cfd/cfd.py
badd +1 ~/ucsc/master-2/quarter-1/computational-fluids/assignment_02/sample_code/advect.m
badd +1 ~/ucsc/master-2/quarter-1/computational-fluids/assignment_02/sample_code/upwind.m
badd +49 ~/ucsc/master-2/quarter-1/computational-fluids/assignment_02/code/Driver_DiffyQ.f90
badd +2 ~/ucsc/master-2/quarter-1/computational-fluids/cfd/cfd/__init__.py
badd +59 ~/ucsc/master-2/quarter-1/computational-fluids/assignment_02/code/DiffyQ.f90
badd +10 DiffyQ/CFD.py
badd +42 ~/ucsc/master-2/quarter-1/machine-learning/assignment_02/HW2_\#6/submission/Train.py
badd +57 ~/ucsc/master-2/quarter-1/machine-learning/assignment_02/HW2_\#6/submission/Classifier.py
